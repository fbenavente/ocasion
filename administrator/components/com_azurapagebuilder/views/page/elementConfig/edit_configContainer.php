...
<div class="width100 azura-element-block" data-typeName="<?php echo $element->type;?>">
	...
	<div class="azuraAddElementWrapper hide-in-elements <?php echo $this->elements_expand;?>"  style="text-align: center; vertical-align: bottom; background-color:#f5f5f5;"><i class="fa fa-plus azuraAddElement"  title="Add element to container"  style="color: rgb(204, 204, 204); margin: 0px auto; font-size: 16px; cursor: pointer;"></i></div>
