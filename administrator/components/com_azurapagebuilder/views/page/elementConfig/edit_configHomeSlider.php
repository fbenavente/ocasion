...
<div class="width100 azura-element-block ui-draggable ui-draggable-handle" data-typeName="<?php echo $element->type;?>">
	...
	<div class="azura-element-type-<?php echo strtolower($element->type);?>-container">
		...
		<div class="hide-in-elements"  style="text-align: center; vertical-align: bottom; margin-top: 5px;"><i class="fa fa-plus homeAddSlider" title="Add slide"  style="color: rgb(204, 204, 204); margin: 0px auto; font-size: 20px; cursor: pointer;"></i></div>
		<?php
