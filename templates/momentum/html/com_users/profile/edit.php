...
<div class="profile-edit<?php echo $this->pageclass_sfx?>">
	...
	<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal well form" enctype="multipart/form-data">
	...
	<?php endif; ?>
		...
		<div class="control-group">
			...
			<br>
				...
				<a class="btn outline" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
