...
$('input, select','#vimeo_options').not('#vimeo_embed').each(function(){var k=$(this).attr('id'),v=$(this).val();k=k.substr(k.indexOf('_')+1);if($(this).is(':checkbox')){v=$(this).is(':checked')?1:0;}
...
break;}
args[k]=v;});if(args.clip_id){id=args.clip_id;}else{var s=/vimeo\.com\/(\w+\/)?(\w+\/)?([0-9]+)/.exec(src);if(s&&$.type(s)==="array"){id=s.pop();}}
