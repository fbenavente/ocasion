...
jQuery.fn.fs_gallery = function (fs_options) {
    ...
    while (thisSlide <= fs_options.slides.length - 1) {
        ...
        $fs_thmb.append('<li class="fs_slide_thmb slide' + thisSlide + '" data-count="' + thisSlide + '"><img width="120" height="120" alt="' + fs_options.slides[thisSlide].alt + ' ' + thisSlide + '" src="' + fs_options.slides[thisSlide].thmb + '"/><div class="fs_thmb_fadder"></div></li>');
        thisSlide++;
    }
    ...
    nextSlide = function () {
        ...
        $fs_descr.fadeOut(300, function () {
            ...
            $fs_title.fadeIn(300).addClass(descr_class);
            $fs_descr.fadeIn(300).addClass(descr_class);
        });
